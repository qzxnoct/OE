...
namespace Oblivion_Engine_Editor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.SpecialFolder.ApplicationData}\OEEditor\";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Oblivion\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Oblivion\Screenshot.png");
